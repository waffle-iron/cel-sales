...
/**
 * Performance test for the MensajeLog entity.
 */
class MensajeLogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MensajeLog entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all mensajeLogs")
            .get("/api/mensaje-logs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created mensajeLog")
                .get("${new_mensajeLog_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created mensajeLog")
            .delete("${new_mensajeLog_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
