...
/**
 * Performance test for the Diagnostico entity.
 */
class DiagnosticoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Diagnostico entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all diagnosticos")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created diagnostico")
                .get("${new_diagnostico_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created diagnostico")
            .delete("${new_diagnostico_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
